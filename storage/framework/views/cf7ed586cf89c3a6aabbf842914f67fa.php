...
<body>
    ...
    <!-- Sidebar -->
    <div class="sidebar">
        <a href="<?php echo e(url('/admin')); ?>" class="active">Dashboard</a>
        <a href="<?php echo e(url('/admin/detail-staff')); ?>">Kelola Akun</a>
    </div>
...
<?php /**PATH C:\xampp\htdocs\ukk-app\resources\views\admin\index.blade.php ENDPATH**/ ?>